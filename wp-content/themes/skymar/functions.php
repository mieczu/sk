...
if(!is_user_logged_in()) {
    ...
    if($referrer && !strstr($referrer, 'wp-login') && !strstr($referrer, 'wp-admin')) {
        wp_redirect('/skymar/wp-login.php');
        exit;
    }
}
...
//    wp_enqueue_script('jquery',get_stylesheet_directory_uri() . '/js/custom_script.js',array( 'jquery' ));
    wp_enqueue_script('jquery','http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.min.js',array(),'1.7');
    wp_enqueue_script('spinner',$template_url . '/js/plugins/spinner/ui.spinner.js',array( 'jquery' ));
    wp_enqueue_script('mousewheel',$template_url . 'js/plugins/spinner/jquery.mousewheel.js',array( 'jquery' ));
    wp_enqueue_script('jquery-ui','http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js',array( 'jquery' ).'1.8');
    wp_enqueue_script('jquery',$template_url . '/js/custom_script.js',array( 'jquery' ));
    wp_enqueue_script('jquery',$template_url . '/js/custom_script.js',array( 'jquery' ));
    wp_enqueue_script('jquery',$template_url . '/js/custom_script.js',array( 'jquery' ));
    wp_enqueue_script('jquery',$template_url . '/js/custom_script.js',array( 'jquery' ));
    wp_enqueue_script('jquery',$template_url . '/js/custom_script.js',array( 'jquery' ));
