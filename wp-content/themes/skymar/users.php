...
//C:\wamp\www\skymar\wp-admin\includes\template.php
//require_once( dirname( __FILE__ ) . '\..\..\..\wp-admin\admin.php' );
require_once( dirname( __FILE__ ) . '\..\..\..\wp-admin\includes\screen.php' );
require_once( dirname( __FILE__ ) . '\..\..\..\wp-admin\includes\template.php' );
require_once( dirname( __FILE__ ) . '\..\..\..\wp-admin\includes\class-wp-list-table.php' );
require_once( dirname( __FILE__ ) . '\..\..\..\wp-admin\includes\list-table.php' );
