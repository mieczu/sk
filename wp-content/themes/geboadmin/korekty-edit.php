...
$results_sub     = $wpdb->get_results('SELECT * FROM wp_czm_korekty_items_to_invoices WHERE id_invoice='.$_REQUEST['id'].' ORDER BY 2 DESC', OBJECT);

$results_orders  = $wpdb->get_results('SELECT * FROM wp_czm_orders WHERE id='.$results_invoice->id_order.' ORDER BY 2 DESC', OBJECT);
$results_orders = $results_orders['0'];

?>
<div class="row-fluid">
    <div class="span12">
        <h3 class="heading">Edytuj fakturę korygującą</h3>
            ...
            <div class="formSep">
                <div class="row-fluid">
                    <div class="span2">
                        ...
                        <input type="text" value="<?php echo $results_invoice->numer; ?>" disabled class="span10">
                    </div>
                    <div class="span2">
                        <label><span class="error_placement">Data wystawienia</span> <span
                                class="f_req">*</span></label>
                        <input type="text" value="<?php echo substr($results_invoice->date_add, 0, 10); ?>" disabled
                               class="span10">
                    </div>
                    <div class="span2">
                        <label><span class="error_placement">Numer zlecenia</span> <span
                                class="f_req">*</span></label>
                        <input type="text" value="<?php echo $results_orders->number; ?>" disabled class="span10">
                    </div>
                    <div class="span2">
                        <label><span class="error_placement">Data wykonania usługi</span> <span
                                class="f_req">*</span></label>
                        <input type="text" value="<?php echo $results_orders->date_execute; ?>" disabled
                               class="span10">
                ...
                <div class="row-fluid">
                    <div class="span1">
                        ...
                        <input type="text" name="post_code" class="span12"
                               value="<?php echo $results->post_code; ?>"/>
                    </div>
                    <div class="span2">
    ...
    <div class="row-fluid">
        <div class="span8">
            ...
            <textarea name="reason" id="reason" cols="10" rows="3" class="span12"><?php echo $results->reason; ?></textarea>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span8">
    ...
    <div class="form-actions">
        <input class="id_invoice" name="id_invoice" type="hidden"
               value="<?php echo $results->id_invoice; ?>">
